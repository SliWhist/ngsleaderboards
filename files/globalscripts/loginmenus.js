...
async function headerGenerate () {
    ...
    if (userInfo == null) {
        ...
        <a class="btn btn-outline-secondary" href="http://localhost:4280/login" role="button">Login</a>
        </li>`;
    }
    if (userInfo != null) {
...
function createNameButton() {
  ...
  buttonref.classList.add("btn","btn-outline");
  buttonref.setAttribute("role","button");
  buttonref.setAttribute("href","http://localhost:4280/logout");
